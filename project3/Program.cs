        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "F:\\project3\\project_3\\studentdata1.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("F:\\project3\\project_3\\studentdata2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("F:\\project3\\project_3\\studentdata3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("F:\\project3\\project_3\\studentdata1.txt").Split(' ');
